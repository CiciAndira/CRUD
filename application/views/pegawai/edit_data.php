        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    ...
                    <?php echo form_open("pegawai/ubah/".$pegawai->id); ?>
                    
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    <input class="input--style-1" type="text" placeholder="ID" name="input_id" value="<?php echo set_value('input_id', $pegawai->id); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="NAMA" name="input_nama" value="<?php echo set_value('input_nama', $pegawai->nama); ?>">
                        </div>
                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="DEPARTEMEN" name="input_dept" value="<?php echo set_value('input_dept', $pegawai->dept); ?>">
                        </div>
                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="TELEPON" name="input_telp" value="<?php echo set_value('input_telp', $pegawai->telp); ?>">
                        </div>
